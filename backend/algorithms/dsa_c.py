    ...
    def run_synchronous_iteration(self) -> AlgorithmStepResult:
        ...
        for agent_id in range(self._problem.num_agents):
            ...
            for candidate_value in range(self._problem.domain_size):
                ...
                # DSA-C accepts equal-cost moves: a strictly lower cost wins, and
                # on a tie the lower-index value wins so plateau (sideways) moves
                # are possible. This is what distinguishes DSA-C from DSA-A.
